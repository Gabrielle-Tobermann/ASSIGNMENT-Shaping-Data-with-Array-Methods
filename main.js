...
// ONLY BUSINESSES WITH AN ORDER > 9000
...
planets.forEach((planet, i) => {
  planetEl.innerHTML += `<li>${planet}</li>`
...
*/
upper = planets.map((planet) => {
  firstLetter =  planet[0].toUpperCase(); // first letter capitalized
  rest = planet.slice(1); // rest of the word
